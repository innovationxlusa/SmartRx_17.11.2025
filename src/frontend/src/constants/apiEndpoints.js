...
// Reward Benefits
export const GET_ALL_REWARD_BENEFITS_URL = "Reward/GetAllRewards";
// Reward Points
export const PATIENT_REWARDS_SUMMARY_URL = "PatientReward/GetPatientRewardsSummary";
...
export const GET_PATIENT_REWARDS_BY_USER_ID_AND_PATIENT_ID_URL = "PatientReward/GetPatientRewardsByUserIdAndPatientId";
//Country Code API
