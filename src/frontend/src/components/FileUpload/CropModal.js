...
const CropModal = ({ isOpen, onClose, files, folderData, onCropDone, onFileSelected }) => {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            formDataToSend.append("LoginUserId", newData.LoginUserId || Number(user?.UserId));
                ...
                <div className="cropper-wrapper">
                    ...
                    {isPdfFile(currentFile) && (
                        ...
                        <div className="pdf-preview">
                            <p>Preview of the PDF:</p>
                            <iframe src={URL.createObjectURL(currentFile)} title="PDF Preview"></iframe>
                        </div>
                        </>
                    )}
