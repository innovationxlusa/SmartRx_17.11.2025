...
namespace PMSBackend.Databases.Data
{
    public class PMSDbContext : DbContext
    {
        ...
        public DbSet<Configuration_RewardBenefit> Configuration_RewardBenefit { get; set; }
        public DbSet<SmartRx_PatientReward> SmartRx_PatientReward { get; set; }
        public DbSet<SmartRx_RewardPointConversions> SmartRx_RewardPointConversions { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Configuration_RewardBenefit>()
                .HasOne(b => b.Reward)
                .WithMany()
            ...
            modelBuilder.Entity<SmartRx_RewardPointConversions>()
                .HasOne(x => x.CreatedBy)
                .WithMany()
