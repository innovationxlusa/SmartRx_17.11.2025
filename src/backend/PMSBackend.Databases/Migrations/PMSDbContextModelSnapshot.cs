...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_DoctorChamberEntity", b =>
                {
                    ...
                    b.Property<string>("DoctorVisitingDaysInChamber")
                        .IsRequired()
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_InvestigationEntity", b =>
                {
                    ...
                    b.Property<string>("NationalPriceReference")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_Reward", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("IsNegativePointAllowed")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("NonCashablePoints")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Configuration_Reward");
                });

            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_RewardBadge", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Configuration_RewardBadge");
                });

            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_RewardBenefit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Configuration_RewardBenefit");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.RefreshTokenEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Security_RefreshToken");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientDoctorEntity", b =>
                {
                    ...
                    b.Property<int?>("ChamberWaitTimeMinute")
                        .HasColumnType("int");

                    b.Property<string>("Comments")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ConsultingDurationInMinutes")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("TravelTimeMinute")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientMedicineEntity", b =>
                {
                    ...
                    b.Property<decimal>("Dose10InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose11InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose12InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose1InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose2InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose3InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose4InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose5InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose6InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose7InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose8InADay")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("Dose9InADay")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientOtherExpenseEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("CurrencyUnitId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SmartRx_PatientOtherExpense");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientReward", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("ConsumedCashablePoints")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ConsumedNonCashablePoints")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("ConvertedCashableToMoney")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ConvertedCashableToNonCashablePoints")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ConvertedNonCashableToCashablePoints")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("EarnedCashablePoints")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("EarnedNonCashablePoints")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("EncashedMoney")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("TotalCashablePoints")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalMoney")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalNonCashablePoints")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("SmartRx_PatientReward");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_RewardPointConversions", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SmartRx_RewardPointConversions");
                });
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Configuration_RewardBenefit", b =>
                {
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_Reward", "Reward")
                        .WithMany()
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientOtherExpenseEntity", b =>
                {
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_UnitEntity", "CurrencyUnit")
                        .WithMany()
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Prescription_UploadEntity", "Prescription")
                        .WithMany("SmartRx_PatientOtherExpense")
                        .HasForeignKey("PrescriptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.SmartRx_PatientReward", b =>
                {
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_RewardBadge", "RewardBadge")
                        .WithMany("PatientRewards")
                    ...
                    b.HasOne("PMSBackend.Domain.Entities.Configuration_Reward", "Rewards")
                        .WithMany()
                        .HasForeignKey("RewardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PMSBackend.Domain.Entities.Prescription_UploadEntity", b =>
                {
                    ...
                    b.Navigation("SmartRx_PatientOtherExpense");
                });
