...
{
    public class CreateRewardBenefitCommand : IRequest<RewardBenefitsDTO>
    {
    ...
    public class CreateRewardBenefitCommandHandler : IRequestHandler<CreateRewardBenefitCommand, RewardBenefitsDTO>
    {
        private readonly IRewardBenefitRepository _rewardBenefitRepository;
        private readonly IRewardRepository _rewardRepository;

        public CreateRewardBenefitCommandHandler(IRewardBenefitRepository rewardBenefitRepository, IRewardRepository rewardRepository)
        {
            _rewardBenefitRepository = rewardBenefitRepository;
            _rewardRepository = rewardRepository;
        }

        public async Task<RewardBenefitsDTO> Handle(CreateRewardBenefitCommand request, CancellationToken cancellationToken)
        {
            ...
            var newRewardBenefit = await _rewardBenefitRepository.CreateRewardBenefitAsync(rewardBenefit, cancellationToken);

            var dto = new RewardBenefitDTO
            {
                Id = newRewardBenefit.Id,
                Title = newRewardBenefit.Title,
                Description = newRewardBenefit.Description,
                RewardId = newRewardBenefit.RewardId,
                RewardHeading = reward.Heading,
                IsActive = newRewardBenefit.IsActive
            };
            ...
            responseResult.ApiResponseResult = new ApiResponseResult
            {
                ...
                Status = "Success",
                Message = "Reward benefit created successfully"
            };
            return responseResult;
        }
    }
